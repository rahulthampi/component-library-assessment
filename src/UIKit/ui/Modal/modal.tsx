...
const Descrition = React.forwardRef<
...
Descrition.displayName = DialogPrimitive.Description.displayName;
...
export { Root, Trigger, Content, Header, Footer, Title, Descrition, Close };
